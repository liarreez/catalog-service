...
class BookJsonTests {
    ...
    void testSerialize() throws Exception {
        var now = Instant.now();
        var book = new Book(394L, "1234567890", "Title", "Author", 9.90, "Reezsophia", now, now, 21);
    ...
    void testDeserialize() throws Exception {
        ...
        assertThat(json.parse(content))
                ...
                .isEqualTo(new Book(394L, "1234567890", "Title", "Author", 9.90, "Reezsophia", instant, instant, 21));
    }
